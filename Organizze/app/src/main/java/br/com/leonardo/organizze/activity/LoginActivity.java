        ...
        buttonEntrar.setOnClickListener(v -> {
            ...
            if ( !textoEmail.isEmpty() ){
                if ( !textoSenha.isEmpty() ){
                    ...
                    Toast.makeText(LoginActivity.this, "Preenhca a senha",Toast.LENGTH_SHORT).show();
                }
            }else {
                Toast.makeText(LoginActivity.this, "Preenhca o email",Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        .addOnCompleteListener(task -> {
            ...
            if (task.isSuccessful()) {
                ...
                try {
                    ...
                    excecao = "E-mail e senha não correspodem a nenhum usuário cadastrado";
                }catch (Exception e){
