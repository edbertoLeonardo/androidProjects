                ...
                if (task.isSuccessful()) {
                 ...
                 try {
                     ...
                     if (verificaTipoUsuario() == "P") {
                         ...
                         finish();
                         Toast.makeText(CadastroActivity.this, "Suacesso ao cadastrar Passageiro", Toast.LENGTH_SHORT).show();

                     } else {
                         startActivity(new Intent(CadastroActivity.this, RequisicoesActivity.class));
                         finish();
                         Toast.makeText(CadastroActivity.this, "Suacesso ao cadastrar Motorista", Toast.LENGTH_SHORT).show();
